...
pub contract ${contractName}: FungibleToken {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @${contractName}.Vault
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @${contractName}.Vault {
            pre {
    ...
    init() {
        ...
        self.VaultStoragePath = /storage/${contractName}Vault
        self.ReceiverPublicPath = /public/${contractName}Receiver
        self.BalancePublicPath = /public/${contractName}Balance
